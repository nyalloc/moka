...
public:
		...
		: app(app_settings)
	{
		...
		material_ = 
		{ 
			graphics_.make_program(
				graphics_.make_shader(shader_type::vertex, vertex_source_),
				graphics_.make_shader(shader_type::fragment, fragment_source_)) 
		};
	}
