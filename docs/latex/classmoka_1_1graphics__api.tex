\hypertarget{classmoka_1_1graphics__api}{}\section{moka\+::graphics\+\_\+api Class Reference}
\label{classmoka_1_1graphics__api}\index{moka::graphics\_api@{moka::graphics\_api}}
...
\mbox{\Hypertarget{classmoka_1_1graphics__api_abd54303be7fb42a6d85092ebee5b605e}\label{classmoka_1_1graphics__api_abd54303be7fb42a6d85092ebee5b605e}} 
\index{moka::graphics\_api@{moka::graphics\_api}!````~graphics\_api@{$\sim$graphics\_api}}
\index{````~graphics\_api@{$\sim$graphics\_api}!moka::graphics\_api@{moka::graphics\_api}}
...
\mbox{\Hypertarget{classmoka_1_1graphics__api_a6f4cbced2ebc8383e60cc25217b839d7}\label{classmoka_1_1graphics__api_a6f4cbced2ebc8383e60cc25217b839d7}} 
\index{moka::graphics\_api@{moka::graphics\_api}!graphics\_api@{graphics\_api}}
\index{graphics\_api@{graphics\_api}!moka::graphics\_api@{moka::graphics\_api}}
\subsubsection{\texorpdfstring{graphics\_api()}{graphics\_api()}\hspace{0.1cm}{\footnotesize\ttfamily [1/3]}}
{\footnotesize\ttfamily moka\+::graphics\+\_\+api\+::graphics\+\_\+api (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [default]}}

\mbox{\Hypertarget{classmoka_1_1graphics__api_a48c08e0eea506774961129654c297e06}\label{classmoka_1_1graphics__api_a48c08e0eea506774961129654c297e06}} 
\index{moka::graphics\_api@{moka::graphics\_api}!graphics\_api@{graphics\_api}}
\index{graphics\_api@{graphics\_api}!moka::graphics\_api@{moka::graphics\_api}}
\subsubsection{\texorpdfstring{graphics\_api()}{graphics\_api()}\hspace{0.1cm}{\footnotesize\ttfamily [2/3]}}
{\footnotesize\ttfamily moka\+::graphics\+\_\+api\+::graphics\+\_\+api (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classmoka_1_1graphics__api}{graphics\+\_\+api}} \&}]{rhs }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [default]}}

\mbox{\Hypertarget{classmoka_1_1graphics__api_a25f5b4fa6fc7b42205e8e12843473121}\label{classmoka_1_1graphics__api_a25f5b4fa6fc7b42205e8e12843473121}} 
\index{moka::graphics\_api@{moka::graphics\_api}!graphics\_api@{graphics\_api}}
\index{graphics\_api@{graphics\_api}!moka::graphics\_api@{moka::graphics\_api}}
\subsubsection{\texorpdfstring{graphics\_api()}{graphics\_api()}\hspace{0.1cm}{\footnotesize\ttfamily [3/3]}}
{\footnotesize\ttfamily moka\+::graphics\+\_\+api\+::graphics\+\_\+api (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classmoka_1_1graphics__api}{graphics\+\_\+api}} \&\&}]{rhs }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [default]}}



\subsection{Member Function Documentation}
\mbox{\Hypertarget{classmoka_1_1graphics__api_a493d46d804ed3dcbe6e9b8bd20d5bb6f}\label{classmoka_1_1graphics__api_a493d46d804ed3dcbe6e9b8bd20d5bb6f}} 
\index{moka::graphics\_api@{moka::graphics\_api}!destroy@{destroy}}
\index{destroy@{destroy}!moka::graphics\_api@{moka::graphics\_api}}
...
\mbox{\Hypertarget{classmoka_1_1graphics__api_ac697780264c97703191fac805198be1e}\label{classmoka_1_1graphics__api_ac697780264c97703191fac805198be1e}} 
\index{moka::graphics\_api@{moka::graphics\_api}!make\_frame\_buffer@{make\_frame\_buffer}}
\index{make\_frame\_buffer@{make\_frame\_buffer}!moka::graphics\_api@{moka::graphics\_api}}
...
\mbox{\Hypertarget{classmoka_1_1graphics__api_a7c7d927d38be3e441c91a5545b06c779}\label{classmoka_1_1graphics__api_a7c7d927d38be3e441c91a5545b06c779}} 
\index{moka::graphics\_api@{moka::graphics\_api}!make\_index\_buffer@{make\_index\_buffer}}
\index{make\_index\_buffer@{make\_index\_buffer}!moka::graphics\_api@{moka::graphics\_api}}
...
Implemented in \mbox{\hyperlink{classmoka_1_1gl__graphics__api_a553669863538cbfab92a98f0f38c0040}{moka\+::gl\+\_\+graphics\+\_\+api}}.

\mbox{\Hypertarget{classmoka_1_1graphics__api_a8477dfbb8aad44e0828114c68fc21792}\label{classmoka_1_1graphics__api_a8477dfbb8aad44e0828114c68fc21792}} 
\index{moka::graphics\_api@{moka::graphics\_api}!make\_program@{make\_program}}
\index{make\_program@{make\_program}!moka::graphics\_api@{moka::graphics\_api}}
...
\mbox{\Hypertarget{classmoka_1_1graphics__api_ad1dd3ca0c1bd1477d2f40d3fae8b1956}\label{classmoka_1_1graphics__api_ad1dd3ca0c1bd1477d2f40d3fae8b1956}} 
\index{moka::graphics\_api@{moka::graphics\_api}!make\_shader@{make\_shader}}
\index{make\_shader@{make\_shader}!moka::graphics\_api@{moka::graphics\_api}}
...
\mbox{\Hypertarget{classmoka_1_1graphics__api_a61417bde89d91f8ec436e54226339b88}\label{classmoka_1_1graphics__api_a61417bde89d91f8ec436e54226339b88}} 
\index{moka::graphics\_api@{moka::graphics\_api}!make\_texture@{make\_texture}}
\index{make\_texture@{make\_texture}!moka::graphics\_api@{moka::graphics\_api}}
...
\mbox{\Hypertarget{classmoka_1_1graphics__api_af4d84630bb43f1573dbf6220b0c02677}\label{classmoka_1_1graphics__api_af4d84630bb43f1573dbf6220b0c02677}} 
\index{moka::graphics\_api@{moka::graphics\_api}!make\_vertex\_buffer@{make\_vertex\_buffer}}
\index{make\_vertex\_buffer@{make\_vertex\_buffer}!moka::graphics\_api@{moka::graphics\_api}}
...
\mbox{\Hypertarget{classmoka_1_1graphics__api_adb071783cb254101b7438f3f939c7806}\label{classmoka_1_1graphics__api_adb071783cb254101b7438f3f939c7806}} 
\index{moka::graphics\_api@{moka::graphics\_api}!operator=@{operator=}}
\index{operator=@{operator=}!moka::graphics\_api@{moka::graphics\_api}}
...
\mbox{\Hypertarget{classmoka_1_1graphics__api_a81c169e6346ce2225fc50cb876c237f8}\label{classmoka_1_1graphics__api_a81c169e6346ce2225fc50cb876c237f8}} 
\index{moka::graphics\_api@{moka::graphics\_api}!operator=@{operator=}}
\index{operator=@{operator=}!moka::graphics\_api@{moka::graphics\_api}}
...
\mbox{\Hypertarget{classmoka_1_1graphics__api_abd438a03be4a08c1cd043a7cefa17cd9}\label{classmoka_1_1graphics__api_abd438a03be4a08c1cd043a7cefa17cd9}} 
\index{moka::graphics\_api@{moka::graphics\_api}!submit@{submit}}
\index{submit@{submit}!moka::graphics\_api@{moka::graphics\_api}}
...
\mbox{\Hypertarget{classmoka_1_1graphics__api_a2b839d3a34c4eb88b0587e40f0616af3}\label{classmoka_1_1graphics__api_a2b839d3a34c4eb88b0587e40f0616af3}} 
\index{moka::graphics\_api@{moka::graphics\_api}!submit\_and\_swap@{submit\_and\_swap}}
\index{submit\_and\_swap@{submit\_and\_swap}!moka::graphics\_api@{moka::graphics\_api}}
