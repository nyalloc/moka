...
#pragma clang diagnostic ignored "-Wformat-security"            // warning : warning: host_format string is not a string literal
...
#pragma GCC diagnostic ignored "-Wformat-security"              // warning : host_format string is not a string literal (potentially insecure)
    ...
    if (ImGui::CollapsingHeader("Widgets"))
    {
        ...
        if (ImGui::TreeNode("Trees"))
        {
            ...
            if (ImGui::TreeNode("Advanced, with Selectable nodes"))
            {
                ...
                static int selection_mask = (1 << 2); // Dumb representation of what may be user-side selection state. You may carry selection state inside or outside your objects in whatever host_format you see fit.
        ...
        if (ImGui::TreeNode("Data Types"))
        {
            ...
            //   bool MySliderU64(const char *label, u64* value, u64 min = 0, u64 max = 0, const char* host_format = "%lld") 
            //   { 
            //      return SliderScalar(label, ImGuiDataType_U64, value, &min, &max, host_format); 
            //   }
