...
//        *        This structure is used throughout moka to pass 4D positions and directions around.
...
//        {
//            return vector4<T>::squared_magnitude(lhs - rhs) < std::numeric_limits<T>::epsilon() * std::numeric_limits<T>::epsilon();
//        }
//
//        template<>
...
//            components_[3] *= rhs.components_[3];
//            return *this;
//        }
//
//        template <typename T>
